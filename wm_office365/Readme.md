...
# Openarmor module: Office365 architecture
## Index
1. [Purpose](#purpose)
...
## Purpose
The audit log allows organization admins to quickly review the actions performed by members of your organization. It ludes details such as who performed the action, what the action was, and when it was performed. 

Openarmor allows you to collect all the logs from Office 365 using its API through:
- Office365 module

## Sequence Diagram
Sequence diagram shows the basic flow of Openarmor Office365 integration based on the configuration provided. Steps are:
...
7. Submit the events to be processed by the Openarmor manager.
